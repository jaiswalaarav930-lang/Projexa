 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Encode Pass/Fail again (models need numeric)\n",
    "df['Previous_Sem_Result'] = df['Previous_Sem_Result'].map({\n",
    "    'Pass': 1,\n",
    "    'Fail': 0\n",
    "})\n",
    "\n",
    "X = df.drop(['Previous_Sem_Result', 'Student_ID'], axis=1)\n",
    "y = df['Previous_Sem_Result']\n"
   ]
  },
  {
   "cell_type": "code",
